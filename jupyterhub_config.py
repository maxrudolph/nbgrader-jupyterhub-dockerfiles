...
# My authenticator configuration from PSU
...
# Configuration for UC Davis Google oauth:
from oauthenticator.google import GoogleOAuthenticator
c.JupyterHub.authenticator_class = GoogleOAuthenticator
c.GoogleOAuthenticator.hosted_domain = ['ucdavis.edu']
c.GoogleOAuthenticator.login_service = 'UC Davis Login'
...
c.JupyterHub.ssl_cert = '/etc/ssl/certs/cert.crt'

## Path to SSL key file for the public facing interface of the proxy
#  
#  When setting this, you should also set ssl_cert
c.JupyterHub.ssl_key = '/etc/ssl/private/private.key'
...
c.JupyterHub.services = [
    {
        ...
        'user': 'grader-gel160',
        'cwd': '/srv/nbgrader/GEL160-Fall2019'
    }
]
